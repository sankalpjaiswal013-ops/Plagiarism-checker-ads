 ...
 *  B.Tech CSE - Advance Data Structures - Group Project
 *  DBS Global University
 *
 *  Data Structures implemented FROM SCRATCH (no STL trees/heaps):
 *    1. Rabin-Karp Rolling Hash   (Unit 5 - String Matching)
 *    2. B-Tree (order 3)          (Unit 1 - Advanced Trees)
 *    3. Extendible Hash Table     (Unit 2 - Hashing)
 *    4. Min-Heap                  (Unit 3 - Heaps)
 *    5. Disjoint Sets (Union-Find)(Unit 5 - Graphs)
 *
 *  Compile:  g++ -std=c++17 -O2 -o plagiarism plagiarism_checker.cpp
 *  Run:      ./plagiarism
 * ============================================================
 */
...
int main() {
    ...
    // Build corpus
    Corpus corpus(4);  // 4-word k-grams
